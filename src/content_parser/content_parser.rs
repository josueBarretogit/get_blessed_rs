    ...
    pub async fn new() -> Self {
        ...
        page_content.crate_groups.iter().for_each(|group| {
            match group.name.trim().to_lowercase().as_str() {
                "common" => {
                    let mut general_group = group.subgroups.as_ref().unwrap().iter();
                    let general_table = general_group
                        .find(|gr| gr.name.trim().to_lowercase().as_str() == "general");
                ...
                TableEntry {
                    ...
                    crates: [
                        Crates {
                            ...
                            description: "Traits like Number, Add, etc that allow you write functions that are generic over the specific numeric
type,".into(),
                            features : None
                        },
                    ].to_vec(),
                ...
                TableEntry {
                    ...
                    crates: [
                        Crates {
                            ...
                            description: "The binary representation consists of a 96 bit integer number, a scaling factor used to specify the
decimal fraction and a 1 bit sign.,".into(),
                            features : None
                        },
                    ].to_vec(),
                },
                TableEntry {
                    ...
                    crates: [
                        Crates {
                            ...
                            description: "Float types that don't allow NaN and are therefore orderable. You can also use the,total_cmp,method from
the standard library like,.sort_by(|a, b| a.total_cmp(&b)),.,".into(),
                            features : None
                        },
                    ].to_vec(),
                },
                TableEntry {
                    ...
                    crates: [
                        Crates {
                            name: "nalgebra".into(),
                            description: "General-purpose linear algebra library with transformations and statically-sized or dynamically-sized
matrices. However it supports only vectors (1d) and matrices (2d) and not higher-dimensional tensors.,".into(),
                ...
                TableEntry {
                    ...
                    crates: [
                        Crates {
                            name: "polars".into(),
                            description: "Similar to the Pandas library in Python but in pure Rust. Uses the Apache Arrow Columnar Format as the
memory model.,".into(),
                            features : None
                        },
                        Crates {
            ...
            entries: [
                ...
                TableEntry {
                    ...
                    crates: [
                        Crates {
                            name: "rutie".into(),
                            description: "Supports both embedding Rust into Ruby applications and embedding Ruby into Rust
applications,".into(),
                            features : None
                        },
                    ].to_vec(),
                ...
                TableEntry {
                    ...
                    crates: [
                        Crates {
                            name: "jni".into(),
                            description: "Implement Java methods for JVM and Android in Rust. Call Java code from Rust. Embed JVM in Rust
applications.,".into(),
                            features : None
                        },
                    ].to_vec(),
            ...
            entries: [
                TableEntry {
                    ...
                    crates: [
                        Crates {
                            name: "clap".into(),
                            description: "Ergonomic, battle-tested, includes the kitchen sink, and is fast at runtime. However compile times can
be slow".into(),
            ...
            entries: [
                TableEntry {
                    ...
                    crates: [
                        Crates {
                            name: "anyhow".into(),
                            description: "Provides a boxed error type that can hold any error, and helpers for generating an application-level
stack trace.".into(),
                            features : None
                        },
                        Crates {
                            name: "color-eyre".into(),
                            description: "A fork of anyhow that gives you more control over the format of the generated error messages.
Recommended if you intend to present error messages to end users. Otherwise anyhow is simpler.".into(),
                            features : None
                        },
                        Crates {
                            name: "thiserror".into(),
            ...
            entries: [
                TableEntry {
                    ...
                    crates: [
                        Crates {
                            name: "gtk4".into(),
                            description: "Rust bindings to GTK4. These are quite well supported, although you'll often need to use the C
documentation.".into(),
                        ...
                        Crates {
                            name: "tauri".into(),
                            description: "Electron-like web-based UI. Except it uses system webviews rather than shipping chromium, and non-UI
code is written in Rust rather than node.js".into(),
                            features : None
                        },
                        Crates {
                            name: "dioxus".into(),
                            description: "A very nice API layer that has Tauri, Web, and TUI renderers. A native renderer is coming
soon.".into(),
                            features : Some(vec!["fullstack".into()])
                        },
                        Crates {
                            name: "egui".into(),
                            description: "Immediate-mode UI. Lots of widgets. The most useable out of the box if your needs are simple and you
don't need to customise of the look and feel".into(),
                            features : None
                        },
                        Crates {
                            name: "iced".into(),
                            description: "Retained mode UI with a nice API. It's useable for basic apps, but has a number of missing features
including multiple windows, layers, and proper text rendering.".into(),
                            features : None
                        },
                        Crates {
                            name: "floem".into(),
                            description: "Inspired by Xilem, Leptos and rui, floem is currently more complete than any of them for native UI.
Used by the Lapce text editor.".into(),
                            features : None
                        },
                        Crates {
                            name: "vizia".into(),
                            description: "Fairly complete with sophisticated layout and text layout, but has yet to make a stable
release.".into(),
                            features : None
                        },
                        Crates {
                            name: "winit".into(),
                            description: "The defacto standard option. Uses an event loop based architecture. Widely used and should probably be
the default choice.".into(),
                            features : None
                        },
                        Crates {
                            name: "tao".into(),
                            description: "A fork of winit by the Tauri project which adds support for things like system menus that desktop apps
need.".into(),
                            features : None
                        },
                        Crates {
                            name: "glazier".into(),
                            description: "A new competitor to winit based on the old druid-shell. Has a callback that may be better than the
event loop architecture for some tasks. Doesn't yet have a stable release.".into(),
                            features : None
                        },
                        Crates {
                            name: "baseview".into(),
                            description: "Specialized window creation library targetting windows to be embedded in other applications (e.g. DAW
plugins)".into(),
                            features : None
                        },
                        Crates {
                        ...
                        Crates {
                            name: "skia-safe".into(),
                            description: "Bindings to the Skia C++ library. The most complete option with excellent performance. However, it can
be difficult to get it to compile.".into(),
                            features : None
                        },
                        Crates {
                            name: "vello".into(),
                            description: "WGPU based and uses cutting edge techniques to render vector paths using the GPU. Still somewhat
immature and hasn't yet put out a stable release.".into(),
                            features : None
                        },
                        Crates {
                            name: "vger".into(),
                        ...
                        Crates {
                            name: "webrender".into(),
                            description: "OpenGL based. Mature with production usage in Firefox but documentation and OSS maintenance are
lacking.".into(),
                            features : None
                        },
                        Crates {
                        ...
                        Crates {
                            ...
                            description: "Full text layout including rich text and support for BiDi and non-latin scripts. The best option for
now.".into(),
                            features : None
                        },
                        Crates {
                        ...
                        Crates {
                            name: "accesskit".into(),
                            description: "Allows you to export a semantic tree representing your UI to make accessible to screen readers and
other assistive technologies".into(),
                            features : None
                        },
                        Crates {
                            name: "arboard".into(),
                            description: "A fork of rust-clipboard that supports copy and pasting of both text and images on Linux
(X11/Wayland), MacOS and Windows.".into(),
                            features : None
                        },
                        Crates {
                            name: "rfd".into(),
            ...
            entries: [
                TableEntry {
                    ...
                    crates: [
                        Crates {
                            name: "sqlx".into(),
                            description: "Works with Postgres, MySQL, SQLite, and MS SQL.Supports compile time checking of queries. Async:
supports both tokio and async-std.".into(),
                            features : Some(vec!["runtime-tokio".into(), "tls-native-tls".into(), "macros".into(), "chrono".into(),
                                "mysql".into()])
                        },
                        Crates {
                            name: "diesel".into(),
                            description: "Has excellent performance and takes an approach of strict compile time guarantees. The main crate is
Sync only, but diesel-async provides an async connection implementation.".into(),
                            features : Some(vec!["mysql".into()])
                        },
                        Crates {
                            name: "sea-orm".into(),
                            description: "Built on top of sqlx (see above). There is also a related sea-query crate that provides a query
builder without full ORM functionality.".into(),
                            features : None
                        },
                        Crates {
            ...
            entries: [
                TableEntry {
                    ...
                    crates: [
                        Crates {
                            name: "tokio".into(),
                            description: "The oldest async runtime in the Rust ecosystem and still the most widely supported. Recommended for
new projects.".into(),
                            features : Some(vec!["full".into()])
                        },
                        Crates {
                            name: "futures-executor".into(),
                            description: "A minimal executor. In particular, the block_on function is useful if you want to run an async
function synchronously in codebase that is mostly synchronous.".into(),
                            features : None
                        },
                        Crates {
                            name: "futures".into(),
                ...
                TableEntry {
                    ...
                    crates: [
                        Crates {
                            name: "http".into(),
                            description: "The `http` crate doesn't actually contain an HTTP implementation. Just types and interfaces to help
interoperability.".into(),
                            features : None
                        },
                        Crates {
                            name: "hyper".into(),
                            description: "A low-level HTTP implementation (both client and server). Implements HTTP/1, and HTTP/2. Works best
with the tokio async runtime, but can support other runtimes.".into(),
                            features : None
                        },
                        Crates {
                            name: "reqwest".into(),
                            description: "Full-fat HTTP client. Can be used in both synchronous and asynchronous code. Requires tokio
runtime.".into(),
                        ...
                        Crates {
                            name: "axum".into(),
                            description: "A minimal and ergonomic framework. An official part of the tokio project. Recommend for most new
projects.".into(),
                            features : Some(vec!["multipart".into(),])
                        },
                        Crates {
                            name: "actix-web".into(),
                            description: "A performance focussed framework. All Rust frameworks are fast, but choose actix-web if you need the
absolutely maximum performance.".into(),
                            features : None
                        },
                        Crates {
                            name: "async-graphql".into(),
                            description: "A high-performance graphql server library that's fully specification compliant. Integrates with
actix-web, axum, poem, rocket, tide, warp.".into(),
                            features : Some(vec!["chrono".into()])
                        },
                    ].to_vec(),
                },
            ...
            entries: [
                TableEntry {
                    ...
                    crates: [
                        ...
                        Crates {
                            name: "rayon".into(),
                            description: "Convert sequential computation into parallel computation with one call - `par_iter` instead of
`iter`".into(),
                            features : None
                        },
                    ].to_vec(),
